...
class ScreenEffect {
	...
	/**
	 * vcr is the white horizontal lines
	 * which appear and disapear fast
	 * the animation logic is on the function:
	 * 		renderTrackingNoise()
	 */ 
	generateVCRNoise() {
...
const screen = new ScreenEffect("#animation-screen", {
...
const config = {
	effects: {
		...
		image: {
			enabled: true,
			options: {
				src: `./images/cowboyBebopPortrait${getRandomInt(0, 4)}.gif`,				
				blur: 1.2
			}
		},
